...
class StaticTextsAddEn extends Section implements Initializable
{
    ...
    public function onDisplay()
    {
        $columns = [
            ...
            AdminColumn::relatedLink('stexten.name', trans('admin.adm_related')),
