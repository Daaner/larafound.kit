...
use App\Model\Lng\NewsCategoryEn;
...
class NewsCategoriesEn extends Section implements Initializable
{
    ...
    protected $alias = 'news-category-en';
    ...
    {
        return trans('admin.adm_news_category_en_header');
    }
    ...
    public function onDisplay()
    {
        $columns = [
            ...
            AdminColumn::custom(trans('admin.adm_parent'), function ($instance) {
                return $instance->parent ? NewsCategoryEn::find($instance->parent)->name : '<span class="text-muted">'. trans('admin.adm_parent_null') .'</span>';})
        ...
        $tableActive =  AdminDisplay::datatables()
            ->setName('news-cat-en-actives')
            ->setModelClass(NewsCategoryEn::class)
    ...
    public function onEdit($id)
    {
        $form=AdminForm::panel()->addBody([
          AdminFormElement::columns()->addColumn([
            ...
            AdminFormElement::select('parent', trans('admin.adm_parent_cat'), NewsCategoryEn::class)
