...
Пакет предназначен для разработки сайтов на Laravel 5.4.28 + ZURB Foundation 6.3.1 (Bootstrap вырезан и присутствует только в админ-панеле).
...
- Роли (очень просто - админ, менеджер и юзер, еще добавить можно в админке)
- В админке можно управлять пользователями и править/добавлять роли
...
## Обновление
Последний `composer update` и `php artisan vendor:publish --tag=assets --force` сделаны 07-07-2017. Работоспособность проверена.
